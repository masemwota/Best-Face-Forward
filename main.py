...
def upload_photo():
    ...
    similar_links = response.web_detection.visually_similar_images
    ...
    entity['link'] = similar_links[1].url

    # Save the new entity to Datastore
    datastore_client.put(entity)

    # Redirect to the home page.
    return render_template('homepage.html', labels=labels, faces=faces, web_entities=web_entities, public_url=image_public_url, similar_links= similar_links)
